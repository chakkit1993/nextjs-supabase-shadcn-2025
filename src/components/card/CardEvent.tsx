...
const CardEvent = () => {
  return (
     <div className="max-w-sx rounded-xl overflow-hidden shadow-lg bg-white">
        <Image
          src="https://images.unsplash.com/photo-1558980664-10e7170b5df9?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          className="w-full"
          width="500"
          height="500"
          sizes="100vw"
        ...
        <div className="grid grid-rows-4 grid-flow-col ">
          ...
          <div className="row flex justify-start px-4 items-center text-black">
            ...
            <span className="px-4">1 ธ.ค. 2566</span>
          </div>
          <div className="row flex justify-start px-4 items-center text-black">
            <span>
              <svg
            ...
            <span className="px-4">วิ่งที่ไหนก็ได้</span>
          </div>
          <div className="row flex justify-start px-4 items-center text-black">
            <span>
              <svg
            ...
            <span className="px-4">โครงการสานสุข</span>
          </div>
        </div>
      </div>
  )
